...
Map mapGroups = {
  ...
  "LETTERS": lettersGroups,
  "OTHER": groups
}; 

Group exampleGroup = Group("baum", [GroupItem("Video", "assets/videos/baum.mp4"), GroupItem("Image", "images/ic_image102.jpg"), GroupItem("Image", "images/ic_image202.jpg")]);

List<Group> basicGroups = [
...
List<Group> lettersGroups = [
  ...
  // Group("ß", [GroupItem("Video", "assets/videos/ß.mp4"), GroupItem("Image", "images/ß.png"), GroupItem("Text", "ß")])
  // Group("ä", [GroupItem("Video", "assets/videos/ä.mp4"), GroupItem("Image", "images/ä.png"), GroupItem("Text", "ä")]),
  // Group("ö", [GroupItem("Video", "assets/videos/ö.mp4"), GroupItem("Image", "images/ö.png"), GroupItem("Text", "ö")]),
  // Group("ü", [GroupItem("Video", "assets/videos/ü.mp4"), GroupItem("Image", "images/ü.png"), GroupItem("Text", "ü")]),
];
